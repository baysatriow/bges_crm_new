...
<head>
	...
	<title>Siswa &mdash; SIAKAD SMK Telkom Lampung</title>
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="red">
				...
				<a href="." class="logo">
					<img src="../assets/img/logo-ts-white.png" width="140" alt="navbar brand" class="navbar-brand">
				</a>
								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg">
												<?php if ($siswa['jenkel'] == "L") { ?>
												<img src="../assets/img/men_avatar.png" alt="image profile" class="avatar-img rounded">
												<?php } else { ?>
												<img src="../assets/img/women_avatar.png" alt="image profile" class="avatar-img rounded">
												<?php } ?>
											</div>
											<div class="u-text">
												<h4><?= $siswa['nama']?></h4>
												<p class="text-muted"><?= $siswa['no_daftar']?></p><a href="logout.php" class="btn btn-xs btn-secondary btn-sm"><i class="fas fa-sign-out-alt"></i> Logout</a>
											</div>
										</div>
									</li>
									<!-- <li>
