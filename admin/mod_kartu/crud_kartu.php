...
if ($pg == 'aktivasi') {
    $tgl_aktivasi = date("Y-m-d h:i:sa");
    $data = [
        'aktivasi' => 1,
        'tgl_aktivasi' => $tgl_aktivasi
    ];
    $id_ujian = $_POST['id_daftar'];
    $exec = update($koneksi, 'daftar', $data, ['id_daftar' => $id_ujian]);
    echo $exec;
}
if ($pg == 'nonaktivasi') {
    $tgl_nonaktivasi = date("Y-m-d h:i:sa");
    $data = [
        'aktivasi' => 0,
        'tgl_nonaktivasi' => $tgl_nonaktivasi
    ];
    $id_ujian = $_POST['id_daftar'];
    $exec = update($koneksi, 'daftar', $data, ['id_daftar' => $id_ujian]);
    echo $exec;
